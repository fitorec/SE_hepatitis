...
SELECT @muestra := COUNT(id) AS muestras_validas FROM `paciente` WHERE edad IS NOT NULL;
...
SELECT @muestra := COUNT(id) AS muestras_validas FROM `paciente` WHERE bilirrubina IS NOT NULL;
...
SELECT @muestra := COUNT(id) AS muestras_validas FROM `paciente` WHERE fosfato_alk IS NOT NULL;
...
SELECT @muestra := COUNT(id) AS muestras_validas FROM `paciente` WHERE sgot IS NOT NULL;
...
SELECT @muestra := COUNT(id) AS muestras_validas FROM `paciente` WHERE albumina IS NOT NULL;
...
SELECT @muestra := COUNT(id) AS muestras_validas FROM `paciente` WHERE protime IS NOT NULL;
